...
kiosk = Equipment.create!(name: "Kiosk Superstructure", equipment_type: "Kiosk", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
grundfos_pump = Equipment.create!(name: "Grundfos Pump", equipment_type: "Pump", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
solar_pannels = Equipment.create!(name: "solar Pannels", equipment_type: "Panel", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
tank_5m3 = Equipment.create!(name: "Tank 5m3", equipment_type: "Tank", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
tank_10m3 = Equipment.create!(name: "Tank 10m3", equipment_type: "Tank", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
filter_system = Equipment.create!(name: "Pentek Filter System", equipment_type: "Filter", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
gac_cto = Equipment.create!(name: "2 Stage Filter System", equipment_type: "Filter", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: Date.today - 20, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
klorman = Equipment.create!(name: "Klorman Inline Dispenser", equipment_type: "Filter", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
softener = Equipment.create!(name: "Water Softener", equipment_type: "Water", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
generator = Equipment.create!(name: "15 KVA Generator", equipment_type: "Electrics", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
booster_pump = Equipment.create!(name: "Booster Pump", equipment_type: "Pump", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
electric_kit = Equipment.create!(name: "Electric Kit", equipment_type: "Electrics", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
batteries = Equipment.create!(name: "Batteries", equipment_type: "Electrics", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
paid_meter = Equipment.create!(name: "Pre-Paid Meter", equipment_type: "Electrics", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: Date.today - 20, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
switch = Equipment.create!(name: "Pressure Switch", equipment_type: "Electrics", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
gauges = Equipment.create!(name: "Pressure Gauges", equipment_type: "Meter", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
valves = Equipment.create!(name: "Ball Valves 40mm", equipment_type: "Electrics", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
dosatron = Equipment.create!(name: "Dosatron", equipment_type: "Pump", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
flow_meter = Equipment.create!(name: "Flow Meter", equipment_type: "Meter", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
totalizer = Equipment.create!(name: "Totalizer", equipment_type: "Meter", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
controller = Equipment.create!(name: "Controller", equipment_type: "Electrics", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
cashpower = Equipment.create!(name: "CashPower", equipment_type: "Meter", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
uv_165W = Equipment.create!(name: "UV System 165W-140LPM", equipment_type: "Electrics", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: Date.today - 20, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
grundfos_submersible_pump = Equipment.create!(name: "Grundfos Submersible Pump", equipment_type: "Pump", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
aquasept = Equipment.create!(name: "Aquasept Inline", equipment_type: "Water", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
sun_pump = Equipment.create!(name: "Sun Pump", equipment_type: "Pump", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
pressure_tank = Equipment.create!(name: "Pressure Tank Manifold", equipment_type: "Tank", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
uv_55W = Equipment.create!(name: "UV System 55W-45LPM", equipment_type: "Electrics", date_of_installation: Date.today, date_of_expiration: Date.today + (3000..4000).to_a.sample, warranty: ((Date.today)..(Date.today + 1000)).to_a.sample, manufacturer: "Handschumacher Ltd", efficiency: "A", design_period: 30, waterpoint: Waterpoint.all.sample, inactive: [true, false, false, false].sample)
...
task_fifteen = Task.create(title: "Kiosk maintenance", start_date: Date.new(2022, 9, 13), end_date: Date.new(2022, 9, 14), extra_info: "The kiosk is old and needs a maintenance check", unscheduled: [true, false, false].sample, completed: false, issuer: christelle, technician: bosco, equipment: kiosk, service: maintenance, waterpoint: rusizi_nexus, network: rusizi_network)
task_sixteen = Task.create(title: "Fill form on time", start_date: Date.new(2022, 9, 13), end_date: Date.new(2022, 9, 14), extra_info: "Make sure to be on time and fill out the form", unscheduled: [true, false, false].sample, completed: false, issuer: christelle, technician: bosco, equipment: generator, service: general, waterpoint: rusizi_nexus, network: rusizi_network)
...
task_swentyseven = Task.create(title: "Catridge switch replacement", start_date: Date.new(2022, 12, 19), end_date: Date.new(2022, 12, 20), extra_info: "Please complete task on time", unscheduled: [true, false, false].sample, completed: false, issuer: christelle, technician: emile, equipment: switch, service: catridge, waterpoint: nyarufunzo_node, network: nyarufunzo_network)
task_twentyeight = Task.create(title: "Water gauge inspection", start_date: Date.new(2022, 12, 20), end_date: Date.new(2022, 12, 21), extra_info: "Take a closer look at the gauges - water has not been runnin", unscheduled: [true, false, false].sample, completed: false, issuer: christelle, technician: emile, equipment: gauges, service: catridge, waterpoint: nyarufunzo_node, network: nyarufunzo_network)
