...
task_one = Task.create(title: "Fix solar panel", start_date: Date.new(2022, 6, 12), end_date: Date.new(2022, 2, 14), extra_info: "Please fix the solar panel", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: romain, equipment: solar_pannels, service: general, waterpoint: rwintare_nexus, network: rwintare_network)
task_two = Task.create(title: "Clean Nexus", start_date: Date.new(2022, 6, 8), end_date: Date.new(2022, 6, 8), extra_info: "Clean the outside area of the Nexus", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: christine, equipment: kiosk, service: cleaning, waterpoint: rusizi_nexus, network: rusizi_network)
task_three = Task.create(title: "Replace filter", start_date: Date.new(2022, 6, 1), end_date: Date.new(2022, 6, 2), extra_info: "Replace the dirty filter", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: bosco, equipment: klorman, service: replacement, waterpoint: nyarufunzo_node, network: nyarufunzo_network)
task_four = Task.create(title: "Kiosk check up", start_date: Date.new(2022, 6, 29), end_date: Date.new(2022, 6, 30), extra_info: "Do a check-up visit on the kiosk", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: djibril, equipment: kiosk, service: general, waterpoint: kavumu_nexus, network: kavumu_network)
task_five = Task.create(title: "Totalizer check up", start_date: Date.new(2022, 6, 22), end_date: Date.new(2022, 6, 24), extra_info: "Do a maintenance check-up on the totalizer", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: totalizer, service: maintenance, waterpoint: rwintare_nexus, network: rwintare_network)
task_six = Task.create(title: "Meter maintenance", start_date: Date.new(2022, 6, 12), end_date: Date.new(2022, 6, 15), extra_info: "Perform maintenance on the meter", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: emile, equipment: paid_meter, service: maintenance, waterpoint: kavumu_nexus, network: kavumu_network)
task_seven = Task.create(title: "Filter cartridge replacement", start_date: Date.new(2022, 6, 20), end_date: Date.new(2022, 6, 21), extra_info: "Catridge replacement on the filter required", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: bosco, equipment: gac_cto, service: catridge, waterpoint: kanyinya_nexus, network: kanyinya_network)
task_nine = Task.create(title: "Softener check", start_date: Date.new(2022, 2, 1), end_date: Date.new(2022, 2, 6), extra_info: "Check on the softener Djibirl", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: softener, service: resin, waterpoint: karukoro_nexus, network: karukoro_network)
task_eight = Task.create(title: "Maintenance task", start_date: Date.new(2022, 3, 2), end_date: Date.new(2022, 3, 5), extra_info: "Please make sure to do the maintenance task", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: softener, service: resin, waterpoint: karukoro_nexus, network: karukoro_network)
task_nine = Task.create(title: "Totalizer maintenance", start_date: Date.new(2022, 2, 3), end_date: Date.new(2022, 2, 5), extra_info: "Task must be schedule: ['Predicted', 'Unpredicted'].sample, completed on time", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: totalizer, service: maintenance, waterpoint: karukoro_nexus, network: karukoro_network)
task_ten = Task.create(title: "Site location check", start_date: Date.new(2022, 1, 5), end_date: Date.new(2022, 1, 7), extra_info: "Check out site location before heading out", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: solar_pannels, service: maintenance, waterpoint: karukoro_nexus, network: karukoro_network)
task_eleven = Task.create(title: "Klorman check", start_date: Date.new(2022, 4, 6), end_date: Date.new(2022, 4, 7), extra_info: "Please take all the required equipment needed", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: klorman, service: maintenance, waterpoint: karukoro_nexus, network: karukoro_network)
task_twelve = Task.create(title: "Task completion", start_date: Date.new(2022, 5, 7), end_date: Date.new(2022, 5, 8), extra_info: "Make sure to complete the task on time", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: paid_meter, service: maintenance, waterpoint: karukoro_nexus, network: karukoro_network)
task_thirteen = Task.create(title: "Maintenance check", start_date: Date.new(2022, 5, 7), end_date: Date.new(2022, 5, 8), extra_info: "Watch out for the task details", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: gac_cto, service: maintenance, waterpoint: karukoro_nexus, network: karukoro_network)
task_fourteen = Task.create(title: "Grundfos pump check", start_date: Date.new(2022, 5, 8), end_date: Date.new(2022, 5, 9), extra_info: "Check with Chris first on what needs to be done", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: grundfos_pump, service: maintenance, waterpoint: karukoro_nexus, network: karukoro_network)
task_fifteen = Task.create(title: "General check up", start_date: Date.new(2022, 5, 8), end_date: Date.new(2022, 5, 9), extra_info: "Please remember to fill out the completion form", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: romain, equipment: grundfos_pump, service: general, waterpoint: kavumu_nexus, network: kavumu_network)
task_sixteen = Task.create(title: "Equipment repair", start_date: Date.new(2022, 7, 8), end_date: Date.new(2022, 7, 10), extra_info: "Please upload an image of the equipment repaired", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: christine, equipment: tank_5m3, service: general, waterpoint: kavumu_nexus, network: kavumu_network)
task_seventeen = Task.create(title: "Tank check", start_date: Date.new(2022, 7, 9), end_date: Date.new(2022, 7, 11), extra_info: "Check with Christelle on the details of the task", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: christine, equipment: tank_5m3, service: general, waterpoint: kavumu_node, network: kavumu_network)
task_eighteen = Task.create(title: "Tank maintenance", start_date: Date.new(2022, 8, 10), end_date: Date.new(2022, 8, 11), extra_info: "Take Emile with you on site and work together", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: christine, equipment: tank_10m3, service: general, waterpoint: kavumu_node, network: kavumu_network)
task_nineteen = Task.create(title: "Tank repair", start_date: Date.new(2022, 8, 10), end_date: Date.new(2022, 8, 12), extra_info: "Ask christine for help on this task", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: christine, equipment: tank_10m3, service: general, waterpoint: rwintare_nexus, network: rwintare_network)
task_twenty = Task.create(title: "Replace filter", start_date: Date.new(2022, 8, 11), end_date: Date.new(2022, 8, 12), extra_info: "Please replace the filter as described", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: christine, equipment: filter_system, service: replacement, waterpoint: rwintare_nexus, network: rwintare_network)
task_thirteen = Task.create(title: "Truck acquiring", start_date: Date.new(2022, 8, 12), end_date: Date.new(2022, 8, 12), extra_info: "Site is off the grid and requires the truck", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: christine, equipment: filter_system, service: general, waterpoint: rwintare_nexus, network: rwintare_network)
task_fourteen = Task.create(title: "Fix water leak", start_date: Date.new(2022, 9, 12), end_date: Date.new(2022, 9, 13), extra_info: "Water has been leaking from the filter - please check", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: christine, equipment: filter_system, service: general, waterpoint: rwintare_node, network: rwintare_network)
task_fifteen = Task.create(title: "Kiosk maintenance", start_date: Date.new(2022, 9, 13), end_date: Date.new(2022, 9, 14), extra_info: "The kiosk is old and needs a maintenance check", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: kiosk, service: maintenance, waterpoint: rusizi_nexus, network: rusizi_network)
task_sixteen = Task.create(title: "Fill form on time", start_date: Date.new(2022, 9, 13), end_date: Date.new(2022, 9, 14), extra_info: "Make sure to be on time and fill out the form", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: generator, service: general, waterpoint: rusizi_nexus, network: rusizi_network)
task_nineteen = Task.create(title: "Technician meeting", start_date: Date.new(2022, 10, 14), end_date: Date.new(2022, 10, 15), extra_info: "Take four additional technicians with you to complete the task", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: booster_pump, service: catridge, waterpoint: rusizi_nexus, network: rusizi_network)
task_twenty = Task.create(title: "Cleaning the site", start_date: Date.new(2022, 10, 14), end_date: Date.new(2022, 10, 15), extra_info: "The site requires cleaning - please make sure its done", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: kiosk, service: cleaning, waterpoint: rusizi_node, network: rusizi_network)
task_twentyone = Task.create(title: "Morning task", start_date: Date.new(2022, 10, 14), end_date: Date.new(2022, 10, 16), extra_info: "Do this task first thing in the morning", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: booster_pump, service: catridge, waterpoint: rusizi_node, network: rusizi_network)
task_twentytwo = Task.create(title: "General service", start_date: Date.new(2022, 11, 15), end_date: Date.new(2022, 11, 17), extra_info: "A general service is rquired at this site", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: electric_kit, service: general, waterpoint: rusizi_nano, network: rusizi_network)
task_twentythree = Task.create(title: "Paint Nexus", start_date: Date.new(2022, 11, 16), end_date: Date.new(2022, 11, 17), extra_info: "Nexus needs to be painted", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: kiosk, service: painting, waterpoint: rusizi_nano, network: rusizi_network)
task_twentyfour = Task.create(title: "Replace batteries", start_date: Date.new(2022, 11, 16), end_date: Date.new(2022, 11, 17), extra_info: "Make sure to take the right tools with you", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: batteries, service: catridge, waterpoint: nyarufunzo_nexus, network: nyarufunzo_network)
task_twentyfive = Task.create(title: "Service check", start_date: Date.new(2022, 12, 17), end_date: Date.new(2022, 12, 18), extra_info: "Make sure to check on the right battereis", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: emile, equipment: batteries, service: catridge, waterpoint: nyarufunzo_nexus, network: nyarufunzo_network)
task_twentysix = Task.create(title: "Nyarufunzu switch check", start_date: Date.new(2022, 12, 18), end_date: Date.new(2022, 12, 19), extra_info: "Please check on the switch at Nyarufunzu", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: emile, equipment: switch, service: catridge, waterpoint: nyarufunzo_nexus, network: nyarufunzo_network)
task_swentyseven = Task.create(title: "Catridge switch replacement", start_date: Date.new(2022, 12, 19), end_date: Date.new(2022, 12, 20), extra_info: "Please complete task on time", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: emile, equipment: switch, service: catridge, waterpoint: nyarufunzo_node, network: nyarufunzo_network)
task_twentyeight = Task.create(title: "Water gauge inspection", start_date: Date.new(2022, 12, 20), end_date: Date.new(2022, 12, 21), extra_info: "Take a closer look at the gauges - water has not been runnin", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: emile, equipment: gauges, service: catridge, waterpoint: nyarufunzo_node, network: nyarufunzo_network)
task_twentynince = Task.create(title: "Nyarufunzo gauge untersuchen", start_date: Date.new(2022, 12, 21), end_date: Date.new(2022, 12, 22), extra_info: "The gauges at Nyarufunzo are not working", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: emile, equipment: gauges, service: cleaning, waterpoint: nyarufunzo_node, network: nyarufunzo_network)
task_thirty = Task.create(title: "Clean valves", start_date: Date.new(2022, 1, 22), end_date: Date.new(2022, 1, 23), extra_info: "Please clean the valves Emile", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: emile, equipment: valves, service: cleaning, waterpoint: nyarufunzo_node, network: nyarufunzo_network)
task_thirtyone = Task.create(title: "Valve replacement", start_date: Date.new(2022, 1, 23), end_date: Date.new(2022, 1, 24), extra_info: "Ask Christelle which valves need to be replaced", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: emile, equipment: valves, service: replacement, waterpoint: kanyinya_nexus, network: kanyinya_network)
task_thirtytwo = Task.create(title: "Maintain dosatron", start_date: Date.new(2022, 1, 24), end_date: Date.new(2022, 1, 25), extra_info: "The dosatron must be maintained", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: emile, equipment: dosatron, service: cleaning, waterpoint: kanyinya_nexus, network: kanyinya_network)
task_thirtythree = Task.create(title: "Cleaning of the Dosatron", start_date: Date.new(2022, 2, 25), end_date: Date.new(2022, 2, 26), extra_info: "Djibril please make sure to ask Christ on the details for the task", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: djibril, equipment: dosatron, service: cleaning, waterpoint: kanyinya_nexus, network: kanyinya_network)
task_thirtyfour = Task.create(title: "Extra maintenance of flow-meter", start_date: Date.new(2022, 3, 26), end_date: Date.new(2022, 3, 27), extra_info: "The flow-meter needs some extra maintenance - please also clean", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: djibril, equipment: flow_meter, service: cleaning, waterpoint: kanyinya_standpipe, network: kanyinya_network)
task_thirtyfive = Task.create(title: "Maintenance form filling", start_date: Date.new(2022, 4, 27), end_date: Date.new(2022, 4, 29), extra_info: "Djibril, dont forget to fill out the maintenance form", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: djibril, equipment: totalizer, service: cleaning, waterpoint: kanyinya_standpipe, network: kanyinya_network)
task_thirtysix = Task.create(title: "Fix controller", start_date: Date.new(2022, 4, 28), end_date: Date.new(2022, 4, 29), extra_info: "The controller is not working - please fix", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: djibril, equipment: controller, service: resin, waterpoint: kanyinya_standpipe, network: kanyinya_network)
task_thirtyseven = Task.create(title: "Technician attendance check", start_date: Date.new(2022, 5, 29), end_date: Date.new(2022, 5, 30), extra_info: "Make sure that all technicians are on time", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: djibril, equipment: controller, service: resin, waterpoint: kanyinya_standpipe, network: kanyinya_network)
task_thirtyeight = Task.create(title: "Fix chaspower", start_date: Date.new(2022, 5, 30), end_date: Date.new(2022, 5, 31), extra_info: "The chaspower must be fixed before tomorrow!", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: djibril, equipment: cashpower, service: resin, waterpoint: karukoro_nexus, network: karukoro_network)
task_thirtynince = Task.create(title: "Resin chaspower", start_date: Date.new(2022, 8, 31), end_date: Date.new(2022, 9, 1), extra_info: "This task is of high priority", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: djibril, equipment: cashpower, service: resin, waterpoint: karukoro_nexus, network: karukoro_network)
task_fourty = Task.create(title: "DRC Vehicle check", start_date: Date.new(2022, 6, 1), end_date: Date.new(2022, 6, 3), extra_info: "This sire is close to the DRC make sure to take the right vehicle", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: djibril, equipment: uv_165W, service: painting, waterpoint: rwintare_node, network: rwintare_network)
task_fourtyone = Task.create(title: "Replace UV", start_date: Date.new(2022, 2, 2), end_date: Date.new(2022, 2, 4), extra_info: "Please take extra care when replacing the UV - thanks Christine", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: christine, equipment: uv_165W, service: replacement, waterpoint: rwintare_node, network: rwintare_network)
task_fourtytwo = Task.create(title: "Grundfos submersible pump maintenance", start_date: Date.new(2022, 2, 3), end_date: Date.new(2022, 2, 5), extra_info: "Bosco, please check with Christine on her task before heading out", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: grundfos_submersible_pump, service: replacement, waterpoint: rwintare_nexus, network: rwintare_network)
...
task_fourtyfour = Task.create(title: "Replace aquasept", start_date: Date.new(2022, 4, 12), end_date: Date.new(2022, 4, 13), extra_info: "Please ask Christelle which aquasept must be replaced", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: aquasept, service: replacement, waterpoint: rusizi_nano, network: rusizi_network)
task_fourtyfive = Task.create(title: "Aquasept untersuchen", start_date: Date.new(2022, 5, 20), end_date: Date.new(2022, 5, 22), extra_info: "This is the third replacement this month, please check whats wrong", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: aquasept, service: replacement, waterpoint: rusizi_nexus, network: rusizi_network)
task_fourtysix = Task.create(title: "Technician training", start_date: Date.new(2022, 6, 1), end_date: Date.new(2022, 6, 2), extra_info: "To all technicians, please fill out form and submit photo", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: sun_pump, service: replacement, waterpoint: rusizi_node, network: rusizi_network)
task_fourtyseven = Task.create(title: "Node check up", start_date: Date.new(2022, 7, 28), end_date: Date.new(2022, 7, 30), extra_info: "Do a check-up on the node and replace the equipment", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: christine, equipment: sun_pump, service: replacement, waterpoint: rusizi_node, network: rusizi_network)
task_fourtyeigth = Task.create(title: "Fix leaking tank", start_date: Date.new(2022, 8, 15), end_date: Date.new(2022, 8, 17), extra_info: "Be caredul with the tank, its leaking", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: christine, equipment: pressure_tank, service: replacement, waterpoint: kanyinya_nexus, network:kanyinya_network)
task_fourtynine = Task.create(title: "Nexus general service", start_date: Date.new(2022, 9, 8), end_date: Date.new(2022, 9, 10), extra_info: "A general service must be provided at the nexus", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: christine, equipment: uv_55W, service: general, waterpoint: kanyinya_nexus, network:kanyinya_network)
...
task_fivtyone = Task.create(title: "Paint Nexus", start_date: Date.new(2022, 6, 17), end_date: Date.new(2022, 6, 17), extra_info: "Nexus needs to be painted", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: bosco, equipment: kiosk, service: painting, waterpoint: rukoronko_nexus, network: rukoronko_network)
task_fivtytwo = Task.create(title: "Clean nexus", start_date: Date.new(2022, 6, 17), end_date: Date.new(2022, 6, 17), extra_info: "Nexus must be cleaned ASAP", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: christine, equipment: kiosk, service: painting, waterpoint: rukoronko_nexus, network: rukoronko_network)
task_twentythree = Task.create(title: "Mugeesra gauges fix", start_date: Date.new(2022, 6, 17), end_date: Date.new(2022, 6, 17), extra_info: "The gauges at Mugeesra are not working", schedule: ['Predicted', 'Unpredicted'].sample, completed: false, issuer: christelle, technician: emile, equipment: gauges, service: cleaning, waterpoint: mugesera_nexus, network: mugesera_network)
task_fivtyfour = Task.create(title: "Paint Nexus", start_date: Date.new(2022, 6, 16), end_date: Date.new(2022, 6, 16), extra_info: "Nexus needs to be painted", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: bosco, equipment: kiosk, service: painting, waterpoint: rukoronko_nexus, network: rukoronko_network)
task_fivtyfive = Task.create(title: "Clean Nexus", start_date: Date.new(2022, 6, 16), end_date: Date.new(2022, 6, 16), extra_info: "Nexus must be cleaned ASAP", schedule: ['Predicted', 'Unpredicted'].sample, completed: true, issuer: christelle, technician: christine, equipment: kiosk, service: painting, waterpoint: rukoronko_nexus, network: rukoronko_network)
